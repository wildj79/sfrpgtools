...
function printPanel(level, name, type, eac, kac, dex, acheck, speed, slots, bulk) {
    ...
    $index.append("<button type=\"button\" id=\"" + indexString + "\" class=\"btn btn-default btn-sm btn-notblack pull-right btn-remove\">Remove</button>");
